...
- 프로젝트가 지금 달성하려는 결과: 배포(T-05)는 나중 문제로 보류(사용자, 2026-09-05). 다음 WP는 사용자 결정 대기(후보: 브리핑 6절). 다음 WP 순서는 사용자 결정(2026-09-05): T-04f → T-05 배포 → OQ-11 lint 경고 축소. 배포 전에 배포 대상·도메인·DB 위치(OQ-20260903-04) 결정 필요. 후보는 T-04f `useLivePrice` 분리, OQ-11 lint 경고 축소, OQ-04 Beta 배포.
