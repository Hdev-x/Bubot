...
milestones:
  - id: css-clean
    ...
    evidence:
      ...
      - kind: command
        locator: "AC-004 재검증: check:css 3종(원본 순서·import 순서·번들 셸 선행) 통과, 검사기를 npm script·CI에 연결. 독립 리뷰어(gpt-6-astra)가 Vite write:false 번들에서 공용 규칙 2034 < 전용 53763, 현재가 라벨 inline-block 14347 < flex 69103 오프셋으로 P0 2건 해소 확인"
        revision: 04adac5
        observed_at: 2026-09-05
      - kind: command
