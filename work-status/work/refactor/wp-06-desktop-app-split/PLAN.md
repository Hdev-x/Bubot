...
acceptance:
  - "AC-001: DesktopApp.tsx가 451줄 이하(D-20260905-01, 2026-09-05 사용자 결정으로 400 → 451, solo 포커스·dock 애니메이션·바깥 클릭 effect 잔류)이고, 새 파일은 각각 400줄 이하다. 소형 컴포넌트·상수·순수 함수는 DesktopApp.tsx 밖에 있다."
