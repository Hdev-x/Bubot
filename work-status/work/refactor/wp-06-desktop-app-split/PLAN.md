...
supersedes: []
outcome: "DesktopApp.tsx가 상태를 조립해 영역 컴포넌트에 넘기는 파일(451줄, 사용자 결정 D-20260905-01 — 원안 300줄 안팎에서 조정)이 되고, 화면 8개 영역은 각자 컴포넌트, 데이터 흐름 5개는 각자 훅으로 나뉜다. 동작·화면은 분해 전과 동일하다."
acceptance:
  - "AC-001: DesktopApp.tsx가 451줄 이하(D-20260905-01, 2026-09-05 사용자 결정으로 400 → 451, solo 포커스·dock 애니메이션·바깥 클릭 effect 잔류) [2026-09-05 정식 변경: wp-08 d02가 useCandleLoader·loadDailyOpen 호출을 조립 파일로 올려 461줄, 사용자 승인 — 이 WP 완료 시점(PR #50) 451은 그대로 사실]이고, 새 파일은 각각 400줄 이하다. 소형 컴포넌트·상수·순수 함수는 DesktopApp.tsx 밖에 있다."
